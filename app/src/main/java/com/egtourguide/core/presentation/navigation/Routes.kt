...
object Routes {
    ...
    const val TOURS_FILTER_SCREEN_ROUTE = "TOURS_FILTER_SCREEN_ROUTE"
    const val LANDMARKS_FILTER_SCREEN_ROUTE = "LANDMARKS_FILTER_SCREEN_ROUTE"
    const val ARTIFACTS_FILTER_SCREEN_ROUTE = "ARTIFACTS_FILTER_SCREEN_ROUTE"
    const val SEARCH_FILTER_SCREEN_ROUTE = "SEARCH_FILTER_SCREEN_ROUTE"
    ...
    const val CUSTOM_EXPANDED_SCREEN_ROUTE = "CUSTOM_EXPANDED_SCREEN_ROUTE/{tourId}"
}
