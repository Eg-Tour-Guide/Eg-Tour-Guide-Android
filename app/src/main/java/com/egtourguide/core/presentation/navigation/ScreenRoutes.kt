...
object ScreenRoutes {
    ...
    const val REVIEW_SCREEN_ROUTE = "REVIEW_SCREEN_ROUTE/{id}/{source}"
    ...
    const val MY_TOURS_SCREEN_ROUTE = "MY_TOURS_SCREEN_ROUTE/{isSelect}"
    const val SAVED_ITEMS_SCREEN_ROUTE = "SAVED_ITEMS_SCREEN_ROUTE"
}